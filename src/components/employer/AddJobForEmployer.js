...
export default function AddJobForEmployer() {
  ...
  const endPoint1 =
    "https://bringjobtomom.herokuapp.com/job/ " +
      ...
      <div class="container mt-3">
        ...
        >
          <Form>
            ...
            <MyTextInput label="Job Title" name="title" type="text" />

            <MyTextInput label="Salary" name="salaryRange" type="text" />
            ...
            <MyTextInput label="Level" name="level" type="text" />
